<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="py-1 menu-inner">
        ...
        <li class="menu-header small text-uppercase">
            <span class="menu-header-text"> &amp;{{__('public._navigation')}}</span>
        </li>
        ...
        <li class="menu-item">
            <a href="{{ route('company.hotel.index') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-grid"></i>
                <div data-i18n="Account Settings">{{__('public._hotels')}}</div>
            </a>
        </li>
        <li class="menu-item">
            <a href="{{ route('company.booking.index') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-calendar"></i>
                <div data-i18n="Account Settings">{{__('public._booking')}}</div>
            </a>
        </li>
        ...
        <li class="menu-item">
            <a href="{{ route('company.service.item.index') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-grid"></i>
                <div data-i18n="Account Settings">{{__('public._services')}}</div>
            </a>
        </li>
        <li class="menu-item">
            <a href="{{ route('company.service.booking.index') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-calendar"></i>
                <div data-i18n="Account Settings">{{__('public._services_booking')}}</div>
            </a>
        </li>
        ...
        <li class="menu-item">
            <a href="{{ route('company.profile.index') }}" class="menu-link">
                ...
                <div data-i18n="Misc">{{__('public._profile')}}</div>
            </a>
        </li>
        ...
        <li class="menu-item">
            ...
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="/locale/en">{{ __('public._english') }}</a>
                </li>
                <li class="menu-item">
                    <a href="/locale/ge">{{ __('public._georgian') }}</a>
                </li>
            </ul>
        </li>
