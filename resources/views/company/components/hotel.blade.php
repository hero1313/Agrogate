    ...
    <div class="layout-page">
        ...
        <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <h4 class="py-3 mb-4"><span class="text-muted fw-light">სასტუმრო {{ __('public._hotel') }} /</span>
                        ...
                        <ul class="mb-3 nav nav-pills flex-column flex-md-row">
                            ...
                            <li class="nav-item">
                                <form action="{{ route('company.hotel.destroy', $hotel->id) }}" method="post">
                                    @csrf
                                    @method('delete')
                                    <button type="submit" class="btn btn-danger">სასტუმროს წაშლა
                                        {{ __('public._hotel_delete') }}</button>
                                </form>
                            </li>
                        </ul>
                        <div class="mb-4 card">
                                    ...
                                    <div class="button-wrapper">
                                        <form id="new-img" action="{{ route('company.image.store', $hotel->id) }}"
                                            ...
                                            <label for="image" class="mb-4 btn btn-primary" tabindex="0">
                                                <span class="d-none d-sm-block">სურათის დამატება
                                                    {{ __('public._add_image') }}</span>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="mb-3 col-12 col-md-6">
                                            <label for="name_ge" class="form-label">დასახელება {{ __('public._name') }}
                                                (ge)</label>
                                            <input class="form-control" type="text" required id="name_ge"
                                                name="name_ge" value="{{ $hotel->name_ge }}" />
                                        </div>
                                        <div class="mb-3 col-12 col-md-6">
                                            <label for="name_en" class="form-label">დასახელება {{ __('public._name') }}
                                                (en)</label>
                                            <input class="form-control" type="text" required id="name_en"
                                                name="name_en" value="{{ $hotel->name_en }}" />
                                        </div>
                                        <div class="mb-3 col-12 col-md-6">
                                            <label for="address_ge" class="form-label">მისამართი
                                                {{ __('public._address') }} (ge)</label>
                                            <input class="form-control" type="text" required id="address_ge"
                                                name="address_ge" value="{{ $hotel->address_ge }}" />
                                        </div>
                                        <div class="mb-3 col-12 col-md-6">
                                            <label for="address_en" class="form-label">მისაართი
                                                {{ __('public._address') }}(en)</label>
                                            <input class="form-control" type="text" required id="address_en"
                                                name="address_en" value="{{ $hotel->address_en }}" />
                                        </div>
                                        <div class="mb-3 col-12 col-md-6">
                                            <label for="city_ge" class="form-label">ქალაქი
                                                {{ __('public._city') }}(ქარ)</label>
                                            <input class="form-control" type="text" required id="city_ge"
                                                name="city_ge" value="{{ $hotel->city_ge }}" />
                                        </div>
                                        <div class="mb-3 col-12 col-md-6">
                                            <label for="city_en" class="form-label">ქალაქი
                                                {{ __('public._city') }}(ინგ)</label>
                                            <input class="form-control" type="text" required id="city_en"
                                                name="city_en" value="{{ $hotel->city_en }}" />
                                        </div>
                                        <div class="mb-3 col-12 col-md-6">
                                            <label for="description_ge" class="form-label">აღწერა
                                                {{ __('public._description') }}(ქარ)</label>
                                            <textarea class="form-control" type="text" id="description_ge" name="description_ge">{{ $hotel->description_ge }}</textarea>
                                        </div>
                                        <div class="mb-3 col-12 col-md-6">
                                            <label for="description_en" class="form-label">აღწერა
                                                {{ __('public._description') }}(ინგ)</label>
                                            <textarea class="form-control" type="text" id="description_en" name="description_en">{{ $hotel->description_en }}</textarea>
                                        </div>
                                        <div class="mb-3 col-12 col-md-6">
                                            <label for="price" class="form-label">ოთახის მინიმალური ფასი
                                                {{ __('public._minimal_price') }}</label>
                                            <input class="form-control" type="number" id="price" min="0"
                                                max="10000" required name="price" value="{{ $hotel->price }}" />
                                        </div>
                                        <div class="mb-3 col-12 col-md-6">
                                            <label for="check_in" class="form-label">ჩექინის დრო
                                                {{ __('public._check_in_time') }}</label>
                                            <input class="form-control" type="time" id="check_in" name="check_in"
                                                value="{{ $hotel->check_in }}" />
                                        </div>
                                        <div class="mb-3 col-12 col-md-6">
                                            <label for="check_out" class="form-label">ჩექაუთის დრო
                                                {{ __('public._check_out_time') }}</label>
                                            <input class="form-control" type="time" id="check_out" name="check_out"
                                                value="{{ $hotel->check_out }}" />
                                        </div>
                                        <div class="mb-3 col-12 col-md-6">
                                            <label for="google_map" class="form-label">რუკის კოდი
                                                {{ __('public._map_code') }}</label>
                                            <textarea class="form-control" type="text" id="google_map" name="google_map">{{ $hotel->google_map }}</textarea>
                                        </div>
                                        <div class="mb-3 col-12 col-md-6">
                                            <label for="seo_description" class="form-label">SEO აღწერა
                                                {{ __('public._seo_description') }}</label>
                                            <textarea class="form-control" type="text" id="seo_description" name="seo_description">{{ $hotel->seo_description }}</textarea>
                                        </div>
                                        <div class="mb-3 col-12 col-md-6">
                                            <label for="seo_title" class="form-label">SEO დასახელება
                                                {{ __('public._seo_title') }}</label>
                                            <input class="form-control" type="text" id="seo_title" name="seo_title"
                                                value="{{ $hotel->seo_title }}" />
                                        </div>
                                        <div class="mb-3 col-12 col-md-6">
                                            <label for="priority" class="form-label">პრიორიტეტი
                                                {{ __('public._priority') }}</label>
                                            <select class="form-select" name="priority"
                                                aria-label="Default select example">
                                                <option value="{{ $hotel->priority }}">{{ $hotel->priority }}</option>
                                                <option value="0">არ აქვს პრიორიტეტი {{ __('public._no_priority') }}
                                                </option>
                                        ...
                                        <div class="mb-3 col-12 col-md-6">
                                            <label for="food" class="form-label">კვება
                                                {{ __('public._name') }}</label>
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <div class="mb-4 d-flex">
                    <h4 class="py-3"><span class="text-muted fw-light">სასტუმრო {{ __('public._name') }} /</span>
                        სერვისები {{ __('public._services') }}</h4>
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <div class="mb-4 d-flex">
                    <h4 class="py-3"><span class="text-muted fw-light">სასტუმრო {{ __('public._hotel') }} /</span>
                        ოთახები {{ __('public._rooms') }}</h4>
            ...
            <div class="modal-content">
                <form action="{{ route('company.service.store', $hotel->id) }}" method="post">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle">სერვისების დამატება
                            {{ __('public._add_service') }}</h5>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="mb-3 col-12 col-md-12">
                                <label for="description_ge" class="form-label">აღწერა {{ __('public._name') }}
                                    (ge)</label>
                                <textarea class="form-control" type="text" id="description_ge" name="description_ge"></textarea>
                            </div>
                            <div class="mb-3 col-12 col-md-12">
                                <label for="description_en" class="form-label">აღწერა {{ __('public._name') }}
                                    (en)</label>
                                <textarea class="form-control" type="text" id="description_en" name="description_en"></textarea>
                            </div>
                            <div class="mb-3 col-12">
                                <label for="price" class="form-label">ფასი ერთ ადამიანზე
                                    {{ __('public._prce_for_person') }}</label>
                                <input class="form-control" required min="0" max="10000" type="number"
                                    id="price" name="price" />
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">გაუქმება
                            {{ __('public._close') }}</button>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <form action="{{ route('company.service.update', $service->id) }}" method="post">
                        ...
                        @method('put')
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLongTitle">სერვისების რედაქტირება
                                {{ __('public._edit_service') }}</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                <div class="mb-3 col-12">
                                    <label for="name_ge" class="form-label">სახელი {{ __('public._name') }}
                                        (ge)</label>
                                    <input class="form-control" required value="{{ $service->name_ge }}" type="text"
                                        id="name_ge" name="name_ge" />
                                </div>
                                <div class="mb-3 col-12">
                                    <label for="name_en" class="form-label">სახელი {{ __('public._name') }}
                                        (en)</label>
                                ...
                                <div class="mb-3 col-12">
                                    <label for="price" class="form-label">ფასი ერთ ადამიანზე
                                        {{ __('public._price_for_persion') }}</label>
                                    <input class="form-control" min="0" max="10000"
                                        value="{{ $service->price }}" type="number" id="price" name="price" />
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <form action="{{ route('company.service.destroy', $service->id) }}" method="post">
                        ...
                        @method('delete')
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLongTitle">სერვისების წაშლა
                                {{ __('public._delete_services') }}</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <form action="{{ route('company.room.store', $hotel->id) }}" method="post">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle">ოთახის დამატება {{ __('public._add_room') }}
                        </h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="mb-3 col-12">
                                <label for="seats" class="form-label">რამდენ ზრდასრულზეა გათვლილი
                                    {{ __('public._how_many_adult') }}</label>
                                <input class="form-control" required min="1" max="10" type="number"
                                    value="2" id="seats" name="seats" />
                            </div>
                            <div class="mb-3 col-12">
                                <label for="child_seats" class="form-label">რამდენ ბავშვზეა გათვლილი
                                    {{ __('public._how_many_child') }}</label>
                                <input class="form-control" type="number" required min="1" max="10"
                                    id="child_seats" name="child_seats" />
                            </div>
                            <div class="mb-3 col-12">
                                <label for="quantity" class="form-label">ასეთი რამდენი ნომერი გაქვთ?
                                    {{ __('public._how_many_room') }}</label>
                                <input class="form-control" type="number" required value="1" min="1"
                                    id="quantity" name="quantity" />
                            </div>
                            <div class="mb-3 col-12">
                                <label for="price" class="form-label">ნომრის ღირებულება 1 ღამე
                                    {{ __('public._price_for_night') }}</label>
                                <input class="form-control" type="number" required min="1" max="10000"
                                    id="price" name="price" />
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <form action="{{ route('company.room.update', $room->id) }}" method="post">
                        ...
                        @method('put')
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLongTitle">ოთახის რედაქტირება
                                {{ __('public._edit_room') }}</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                <div class="mb-3 col-12">
                                    <label for="seats" class="form-label">რამდენ ადამიანზეა გათვლილი
                                        {{ __('public._how_many_adult') }}</label>
                                    <input class="form-control" required min="1" max="10" type="number"
                                        value="2" id="seats" name="seats" value="{{ $room->seats }}" />
                                </div>
                                <div class="mb-3 col-12">
                                    <label for="child_seats" class="form-label">რამდენ ბავშვზეა გათვლილი
                                        {{ __('public._how_many_child') }}</label>
                                    <input class="form-control" required min="1" max="10" type="number"
                                        id="child_seats" name="child_seats" value="{{ $room->child_seats }}" />
                                </div>
                                <div class="mb-3 col-12">
                                    <label for="quantity" class="form-label">ასეთი რამდენი ნომერი გაქვთ?
                                        {{ __('public._how_many_room') }}</label>
                                ...
                                <div class="mb-3 col-12">
                                    <label for="price" class="form-label">ნომრის ღირებულება
                                        {{ __('public._price') }}</label>
                                    <input class="form-control" type="number" required min="1" max="10000"
                                        id="price" name="price" value="{{ $room->price }}" />
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
