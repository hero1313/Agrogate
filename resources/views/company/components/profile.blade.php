            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form method="POST" id="new-image" enctype= multipart/form-data action="{{ route('company.profile.update') }}">
                            @csrf
                            @method('put')
                            <div class="mb-4 card">
                                ...
                                <div class="card-body">
                                    <div class="gap-4 d-flex align-items-start align-items-sm-center">
                                        <img src="{{ Auth::user()->image }}" alt="user-avatar" class="rounded d-block"
                                        ...
                                        <div class="button-wrapper">
                                            ...
                                            <button type="submit" class="mb-4 btn btn-outline-secondary account-image-reset">
